...
## usage visual.py and visualize_2d.py
0. change the `image_dir` and 'json_file'  in the `./visual.py` and './common/visualize.py'
1. Run it, and your result (gif file or mp4 file) will be saved in './outputs' folder
